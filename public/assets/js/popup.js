...
function showPopup(titleText, messageText, type = "error") {
    ...
    // Remove any existing action buttons from previous verifies
    ...
    if (overlay && title && message) {
        ...
        // Ensure OK button is visible and set up for normal popup
        if (!okBtn) {
...
function showConfirm(titleText, messageText, onYes) {
    ...
    if (overlay && title && message) {
        ...
        yesBtn.style.backgroundColor = "#d32f2f"; // Warning color
        ...
        cancelBtn.style.backgroundColor = "#9e9e9e"; // Neutral color
