...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="view_ads.css">
</head>
...
<body>
    ...
    <div class="head">
        ...
        <div class="nav">
            ...
            <a href="..\..\views\transactions\view_transactions.php">Transactions</a>
            <a href="..\..\views\users\logout.php">Logout</a>
        </div>
